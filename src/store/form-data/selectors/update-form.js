...
export const selectSequenceFieldsAmount = (state) => state.formData.sequenceFieldsAmount;
export const selectRegisterFieldsAmount = (state) => state.formData.registerFieldsAmount;
